...
using SimpleCalendar.Core.Bootstrap;
using Swashbuckle.AspNetCore.Swagger;

namespace SimpleCalendar.WebApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            RegisterPartial<CorePartialStartup>(services);
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "SimpleCalendar V1");
            });
